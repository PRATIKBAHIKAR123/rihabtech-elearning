...
import { CourseHistoryEntry, CourseStatus, COURSE_STATUS } from '../utils/firebaseCourses';
                      ...
                      {entry.previousStatus && entry.newStatus && (
                        <span className="flex items-center space-x-1">
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs ${
                            ...
                            entry.previousStatus === COURSE_STATUS.PENDING_APPROVAL ? 'bg-yellow-100 text-yellow-800' :
                            entry.previousStatus === COURSE_STATUS.APPROVED ? 'bg-green-100 text-green-800' :
                            entry.previousStatus === COURSE_STATUS.REJECTED ? 'bg-red-100 text-red-800' :
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs ${
                            ...
                            entry.newStatus === COURSE_STATUS.PENDING_APPROVAL ? 'bg-yellow-100 text-yellow-800' :
                            entry.newStatus === COURSE_STATUS.APPROVED ? 'bg-green-100 text-green-800' :
                            entry.newStatus === COURSE_STATUS.REJECTED ? 'bg-red-100 text-red-800' :
