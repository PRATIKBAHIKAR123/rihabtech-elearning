...
type PricingPlan = {
    ...
    const pricingPlans: PricingPlan[] = [
        ...
        },
        {
            ...
            highlighted: true,
            features: [
                { text: 'Unlimited Creators', hasInfoIcon: true },
                { text: 'Unlimited videos' },
                { text: 'Unlimited recording length' },
                { text: 'Up to 50 Creators Lite', hasInfoIcon: true },
            ],
            keyFeaturesTitle: 'Everything in Starter, plus',
            keyFeatures: [
                { text: 'Custom branding' },
                { text: 'Engagement insights' },
                { text: 'Embed links in video' },
        ...
        },
        {
            ...
            keyFeaturesTitle: 'Everything in Business, plus',
            keyFeatures: [
                { text: 'SSO (SAML) and SCIM' },
                { text: 'Advanced content privacy', hasInfoIcon: true },
                { text: 'Custom data retention policies' },
