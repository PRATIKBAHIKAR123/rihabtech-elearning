...
const initialChats = [
  {
    id: 1,
    sender: 'Suporte ADMIN',
    time: '3:00 PM',
    message: 'Lorem ipsum has been the industry\'s standard dummy text ever since the 1500s.',
    isAdmin: true,
    status: 'Espera',
    messageType: 'Pesquisar chat'
  },
  {
    id: 2,
    sender: 'Suporte ADMIN',
            ...
            {chats.map((chat, index) => (
              <div
                ...
                className={`flex items-center p-4 cursor-pointer hover:bg-gray-50 ${
                  activeChat === index ? 'bg -white rounded-[10px] border border-[#dfe0eb] shadow-[0px_0px_8px_0px_rgba(255,119,0,0.29)]' : ''
                }`}
