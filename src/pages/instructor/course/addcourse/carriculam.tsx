                    ...
                    <div key={sectionIdx} className="mb-8 border rounded p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="flex items-center gap-2 flex-1">
                          <label className="ins-label whitespace-nowrap" style={{ width: 'auto' }}>
                        ...
                        {({ push, remove, replace }) => (
                          <div className="flex flex-col gap-4">
                            {section.items.map((item, itemIdx) => (
                              <div key={itemIdx} className=" border rounded p-3 mb-2 bg-gray-50">
                                {/* LECTURE */}
                                {item.type === "lecture" && (
                                          ...
                                          <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center gap-4 mb-2">
                                              ...
                                              <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <label htmlFor={`video-upload-${sectionIdx}-${itemIdx}`}>Upload file</label>
                                                <input
                                                  type="radio"
                                                ...
                                                />
                                                <label htmlFor={`video-link-${sectionIdx}-${itemIdx}`}>Video link</label>
                                              </div>
                                            </div>
                                            {/* Upload file option */}
