            ...
            <div className="flex justify-between mt-4">
                <div className="flex gap-3 w-1/2">
                    <div className="relative flex-grow">
                        ...
                        <input type="text" placeholder="Search Course" className="bg-neutral-100 border-none rounded-[27px] w-full pl-12 py-2" />
                    </div>
                    <Button variant={'outline'} className="rounded-none border-primary text-primary">Newest</Button>
                </div>
                <Button className="rounded-none" onClick={() => window.location.href = '/#/instructor/course-test-selection'}>Add New Course</Button>
            </div>
            <div className="flex flex-col gap-2 mt-4">
                <div className="bg-white rounded-[15px] shadow-md p-2 flex items-center justify-between hover:shadow-lg  cursor-pointer">
